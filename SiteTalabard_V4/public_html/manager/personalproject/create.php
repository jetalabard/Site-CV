...
if (isset($_POST["submit"])) {
    ...
    $pdo->exec("ALTER TABLE `personalproject` AUTO_INCREMENT = 1");
    $pdo->exec("INSERT INTO links (ID) values(DEFAULT)");
    
    $stmt = $pdo->prepare("INSERT INTO personalproject (title,photo,subtitle,date,resume,idlinks) VALUES (? ,? ,? ,? ,? ,?)");
