...
if (isset($_POST["submit"])) {
    ...
    $pdo->exec("ALTER TABLE `project` AUTO_INCREMENT = 1");
    $pdo->exec("INSERT INTO links (ID) values(DEFAULT)");
    
    $stmt = $pdo->prepare("INSERT INTO project (title,photo,subtitle,date,resume,idlinks) VALUES (? ,? ,? ,? ,? ,?)");
